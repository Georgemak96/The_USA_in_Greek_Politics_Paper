...
#write_csv(parties_scores,"parties_sentiments_2015-2020.csv")
...
#export(date_scores_weighted,"2015-2020_sentiments.xlsx")
...
#write_csv(parties_scores,"ideology_sentiments_2015-2020.csv")
